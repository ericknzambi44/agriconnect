...
export function NotificationCenterView() {
  ...
  if (loading) return (
    <div className="flex flex-col items-center justify-center p-20 min-h-[500px]">
      ...
      <span className="font-tech text-[10px] text-primary/40 uppercase tracking-[0.5em]">Sync_Data...</span>
    </div>
  );
    ...
    <div className="relative z-10 w-full max-w-5xl mx-auto p-4 md:p-6 lg:p-10 animate-in fade-in duration-700">
      ...
      <div className="flex items-center justify-between mb-8 px-2">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h2 className="text-3xl md:text-4xl font-display text-glow-primary">Flux<span className="text-primary">Msg</span></h2>
