        ...
        <CardContent className="px-8 md:px-12 pb-12">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-3">
              <Label className="font-tech text-[10px]  text-primary/50 uppercase tracking-[0.2em] ml-2">Identifiant</Label>
              <Input 
                value={identifier}
            ...
            <div className="space-y-3">
              <div className="flex justify-between items-center px-2">
                <Label className="font-tech text-[10px] text-primary/60 uppercase tracking-[0.2em]">Mot de passe</Label>
                <Link 
                  to="/forgot-password" 
